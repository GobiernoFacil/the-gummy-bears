		...
		<div class="row">
			<div class="col-sm-8 col-xs-12 col-sm-offset-2">
				...
				<div class="row">
					...
					<p class="footnote"><strong>1</strong> Información disponible a partir de la implementación del estándar en 2015.<br><strong>2</strong> El monto contratado es aproximado y corresponde a las contrataciones abiertas realizadas en pesos mexicanos, por lo que el total no contiene las compras  realizadas en otras monedas.</p>
				</div>
				<div class="row">
