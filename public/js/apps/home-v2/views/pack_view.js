...
define(function(require){
  ...
  var content = Backbone.View.extend({
    ...
    render_pack : function(){
      var root = {children : this.data, name : "contracts", _class : "root"},
          pack = d3.layout.pack()
                 .sort(null)
      ...
      enter.append("svg:circle")
          ...
          .attr("stroke", "rgba(238,71,170,0.5)") // rgb(235, 0, 139)
          //.attr("fill", "black")
          //.attr("stroke", "white")
          ...
          .attr("fill", function(d,i){ return "rgba(238,71,170,0.4)" });//Colors(i)
